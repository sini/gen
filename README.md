...
`framework` publishes `gen.lib.framework` — a roster selection per ADR-0015 as amended, never a
...
| [gen-delivery](https://github.com/sini/gen-delivery) | The delivery-class realization surface (ADR-0028): the projection that discovers which aspect keys are declared delivery classes and the fold that hands each class's collected content to its target-owned terminal                                                                                                                                                                                                    |
