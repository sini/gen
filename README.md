...
equality — power dedup across the ecosystem: aspect diamond dedup in gen-aspects, rule identity in
gen-dispatch, selector equality in gen-select, and the content-addressed `id_hash` in gen-schema.
